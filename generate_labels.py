...
class ScoringTexts(BaseModel):
  ...
  AI_generated: int = Field(description="Is the following text AI generated? Select the option that best describes the text."
                                              "Option 1. Most of the text is likely to be generated by AI."
                                              "Option 2. Some of the text is likely to be generated by AI."  
                                              "Option 3. Most of the text is likely to be generated by a human.")
